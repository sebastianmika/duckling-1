...
classifiers
  = HashMap.fromList
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                     ClassData{prior = -0.8911404982513801, unseen = -5.043425116919247,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 153},
                   koData =
                     ClassData{prior = -0.5279508732914541, unseen = -5.402677381872279,
                               ...
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.075173815233827),
                                    ...
                                    ("Septemberhhmm - hhmm (interval)", -5.075173815233827),
       ...
       ("year",
        Classifier{okData =
                     ClassData{prior = -0.2702903297399117,
                               unseen = -3.4339872044851463,
                               likelihoods = HashMap.fromList [("integer (numeric)", 0.0)],
                               n = 29},
                   koData =
       ...
       ("<integer> <unit-of-duration>",
        Classifier{okData =
                     ClassData{prior = -0.8472978603872037, unseen = -4.499809670330265,
                               likelihoods =
                                 HashMap.fromList
                               ...
                               n = 33},
                   koData =
                     ClassData{prior = -0.5596157879354228, unseen = -4.718498871295094,
                               likelihoods =
                                 HashMap.fromList
                                   [("week", -2.917770732084279),
                                    ("integer (0..19)year (grain)", -3.6109179126442243),
                                    ("integer (numeric)day (grain)", -3.3232358401924436),
                                    ("integer (0..19)second (grain) ", -3.6109179126442243),
                                    ("integer (0..19)hour (grain)", -3.6109179126442243),
                                    ("second", -3.100092288878234),
                                    ("integer (numeric)second (grain) ", -3.6109179126442243),
                                    ("integer (numeric)year (grain)", -3.6109179126442243),
                                    ("day", -2.763620052257021), ("quarter", -4.0163830207523885),
                                    ("year", -3.100092288878234),
                                    ("integer (numeric)week (grain)", -3.3232358401924436),
                                    ("integer (0..19)month (grain)", -3.6109179126442243),
                                    ("hour", -1.8763168572561182), ("month", -3.100092288878234),
                                    ("integer (numeric)minute (grain)", -3.6109179126442243),
                                    ("integer (0..19)minute (grain)", -3.6109179126442243),
                                    ("integer (numeric)month (grain)", -3.6109179126442243),
                                    ("minute", -3.100092288878234),
                                    ("integer (numeric)hour (grain)", -2.001480000210124),
                                    ("integer (0..19)day (grain)", -3.3232358401924436),
                                    ("integer (0..19)week (grain)", -3.6109179126442243),
                                    ("integer (0..19)quarter (grain)", -4.0163830207523885)],
                               n = 44}}),
       ("hhmm (latent)",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -2.0794415416798357,
       ...
       ("hh:mm",
        Classifier{okData =
                     ClassData{prior = -8.5522173438162e-2, unseen = -4.060443010546419,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 56},
                   koData =
                     ClassData{prior = -2.501435951739211, unseen = -1.9459101490553135,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 5}}),
       ("quarter of an hour",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
