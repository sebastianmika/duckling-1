      ...
      [("<integer> to|till|before <hour-of-day>",
       ...
       ("integer (numeric)",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -0.5328045304847658, unseen = -5.384495062789089,
       ...
       ("<day-of-month> (ordinal or number) <named-month>",
        Classifier{okData =
                     ClassData{prior = -0.6931471805599453, unseen = -2.639057329615259,
                               likelihoods =
                                 HashMap.fromList
                                   [("integer (numeric)September", -1.8718021769015913),
       ...
       ("intersect",
        Classifier{okData =
                     ClassData{prior = -0.4486938426589846, unseen = -6.12029741895095,
                               likelihoods =
                                 HashMap.fromList
                                   [("<day-of-month> (ordinal or number) <named-month>hhmm - hhmm (interval)",
                                     -5.424950017481403),
                                    ("<datetime> - <datetime> (interval)on <date>",
                                     -4.508659285607248),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -4.508659285607248),
                                    ("hourday", -3.720201925242977),
                                    ("dayhour", -3.1736582188749076),
                                    ("daymonth", -5.424950017481403),
                                    ("monthday", -5.019484909373238),
                                    ("monthyear", -3.8155121050473024),
                                    ("Tuesdaythe <day-of-month> (ordinal)", -5.424950017481403),
                                    ("Christmasyear", -5.424950017481403),
                                    ("this|next <day-of-week>hh(:mm) - <time-of-day> am|pm",
                                     -5.424950017481403),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.7318028369214575),
                                    ("<time-of-day> am|pmintersect", -4.172187048986035),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -5.424950017481403),
                                    ("Marchyear", -5.424950017481403),
                                    ("<named-month>|<named-day> <day-of-month> (ordinal)year",
                                     -5.019484909373238),
                                    ("intersect<time-of-day> am|pm", -5.424950017481403),
                                    ("Thursdayhh(:mm) - <time-of-day> am|pm", -5.424950017481403),
                                    ("monthhour", -5.019484909373238),
                                    ("last <day-of-week> of <time>year", -5.424950017481403),
                                    ("todayat <time-of-day>", -5.424950017481403),
                                    ("Thursday<time> timezone", -5.019484909373238),
                                    ("this <time>hh(:mm) - <time-of-day> am|pm",
                                     -5.424950017481403),
                                    ("dayday", -3.410046996939138),
                                    ("Thanksgiving Dayyear", -5.019484909373238),
                                    ("<time> <part-of-day>at <time-of-day>", -5.424950017481403),
                                    ("Tuesdayin <named-month>", -5.424950017481403),
                                    ("mm/ddat <time-of-day>", -5.424950017481403),
                                    ("tonightat <time-of-day>", -5.424950017481403),
                                    ("<time-of-day> am|pmabsorption of , after named day",
                                     -4.7318028369214575),
                                    ("today<time-of-day> am|pm", -5.424950017481403),
                                    ("Februarythe <day-of-month> (ordinal)", -5.019484909373238),
                                    ("at <time-of-day><time> <part-of-day>", -5.424950017481403),
                                    ("mm/dd<time-of-day> am|pm", -5.424950017481403),
                                    ("hourhour", -4.172187048986035),
                                    ("<time-of-day> am|pmon <date>", -3.410046996939138),
                                    ("Wednesdaythis|last|next <cycle>", -5.424950017481403),
                                    ("intersect<named-month> <day-of-month> (non ordinal)",
                                     -3.9208726207051283),
                                    ("dayyear", -3.2277254401451834),
                                    ("<time-of-day> o'clockin|during the <part-of-day>",
                                     -5.424950017481403),
                                    ("<time-of-day> am|pmtomorrow", -4.7318028369214575),
                                    ("minutehour", -4.508659285607248),
                                    ("Mother's Dayyear", -5.424950017481403),
                                    ("at <time-of-day>in|during the <part-of-day>",
                                     -5.019484909373238),
                                    ("absorption of , after named day<named-month> <day-of-month> (non ordinal)",
                                     -3.720201925242977),
                                    ("tomorrow<time-of-day> sharp|exactly", -5.424950017481403),
                                    ...
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.508659285607248),
                                    ("Mondayin|during the <part-of-day>", -5.424950017481403),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.019484909373238),
                                    ("intersectin|during the <part-of-day>", -5.424950017481403),
                                    ("<day-of-month> (ordinal or number) of <named-month>in|during the <part-of-day>",
                                     -5.424950017481403),
                                    ...
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.019484909373238),
                                    ("<ordinal> <cycle> of <time>year", -5.424950017481403),
                                    ("minuteday", -2.0237526358192475),
                                    ("absorption of , after named dayintersect",
                                     -5.424950017481403),
                                    ("Octoberyear", -4.172187048986035),
                                    ("the <day-of-month> (ordinal)in|during the <part-of-day>",
                                     -5.424950017481403),
                                    ...
                                    ("<day-of-month> (ordinal or number) <named-month>year",
                                     -5.424950017481403),
                                    ("year<time-of-day> am|pm", -5.424950017481403),
                                    ("Septemberyear", -5.019484909373238),
                                    ("at <time-of-day>on <date>", -4.326337728813293),
                                    ("between <time-of-day> and <time-of-day> (interval)on <date>",
                                     -4.7318028369214575),
                                    ("Halloweenyear", -5.424950017481403),
                                    ("dayweek", -5.424950017481403),
                                    ("weekyear", -5.019484909373238),
                                    ("hh:mmin|during the <part-of-day>", -4.7318028369214575),
                                    ("Father's Dayyear", -5.424950017481403),
                                    ("<cycle> after|before <time><time-of-day> am|pm",
                                     -5.019484909373238),
                                    ("February<time> <part-of-day>", -5.424950017481403),
                                    ("Martin Luther King's Dayyear", -5.019484909373238),
                                    ("tomorrowat <time-of-day>", -4.7318028369214575),
                                    ("between <time> and <time>on <date>", -4.7318028369214575),
                                    ("at <time-of-day>tomorrow", -5.019484909373238),
                                    ("tomorrow<time-of-day> am|pm", -5.424950017481403),
                                    ("in|during the <part-of-day>at <time-of-day>",
                                     -5.424950017481403),
                                    ("Labor Dayyear", -5.424950017481403),
                                    ("Februaryintersect", -5.424950017481403),
                                    ("last <cycle> of <time>year", -4.7318028369214575),
                                    ("<named-month> <day-of-month> (non ordinal)year",
                                     -5.424950017481403),
                                    ("yearminute", -5.424950017481403)],
                               n = 166},
                   koData =
                     ClassData{prior = -1.0173868487455238, unseen = -5.739792912179234,
                               likelihoods =
                                 HashMap.fromList
                                   [("in <named-month>year", -5.043425116919247),
                                    ("<time-of-day> - <time-of-day> (interval)on <date>",
                                     -5.043425116919247),
                                    ("hourday", -5.043425116919247),
                                    ("<named-month> <day-of-month> (non ordinal)July",
                                     -5.043425116919247),
                                    ("dayhour", -3.2516656476911914),
                                    ("daymonth", -3.028522096376982),
                                    ("Septemberhhmm - hhmm (interval)", -5.043425116919247),
                                    ("monthday", -4.637960008811082),
                                    ("monthyear", -4.637960008811082),
                                    ("intersecthh:mm", -5.043425116919247),
                                    ("until <time-of-day><time-of-day> am|pm", -5.043425116919247),
                                    ("<time-of-day> am|pmintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -4.350277936359301),
                                    ("<time-of-day> am|pmintersect", -3.7906621484238787),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"year",
                                     -4.350277936359301),
                                    ("Tuesdayafter <time-of-day>", -5.043425116919247),
                                    ("July<day-of-month> (ordinal or number) <named-month>",
                                     -5.043425116919247),
                                    ("absorption of , after named dayJuly", -4.637960008811082),
                                    ("monthhour", -4.637960008811082),
                                    ("todayat <time-of-day>", -5.043425116919247),
                                    ("dayday", -4.637960008811082),
                                    ("mm/ddat <time-of-day>", -4.637960008811082),
                                    ("<time-of-day> am|pmon <date>", -3.7906621484238787),
                                    ("dayyear", -4.127134385045092),
                                    ("Thursdaymm/dd", -5.043425116919247),
                                    ("Thursdayat <time-of-day>", -5.043425116919247),
                                    ("August<time-of-day> am|pm", -5.043425116919247),
                                    ("monthminute", -4.637960008811082),
                                    ...
                                    ("August<day-of-month> (ordinal or number) <named-month>",
                                     -5.043425116919247),
                                    ("minutemonth", -3.5393477201429726),
                                    ("Thursdayfrom <datetime> - <datetime> (interval)",
                                     -4.637960008811082),
                                    ("Thursdayfrom <time-of-day> - <time-of-day> (interval)",
                                     -4.637960008811082),
                                    ("Aprilyear", -5.043425116919247),
                                    ("mm/dd<time-of-day> - <time-of-day> (interval)",
                                     -4.637960008811082),
                                    ("tomorrowfrom <time-of-day> - <time-of-day> (interval)",
                                     -5.043425116919247),
                                    ("yesterday<time-of-day> am|pm", -5.043425116919247),
                                    ("intersect by \",\", \"of\", \"from\", \"'s\"hh:mm",
                                     -4.127134385045092),
                                    ("<named-month> <day-of-month> (non ordinal)August",
                                     -5.043425116919247),
                                    ("until <time-of-day>on <date>", -4.350277936359301),
                                    ("at <time-of-day>intersect", -4.637960008811082),
                                    ("at <time-of-day>intersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.043425116919247),
                                    ("dayminute", -3.0975149678639333),
                                    ("intersectSeptember", -3.5393477201429726),
                                    ("absorption of , after named dayintersect by \",\", \"of\", \"from\", \"'s\"",
                                     -5.043425116919247),
                                    ("minuteday", -2.240064736012712),
                                    ("absorption of , after named dayintersect",
                                     -5.043425116919247),
                                    ("Februaryin|during the <part-of-day>", -5.043425116919247),
                                    ("yearhh:mm", -5.043425116919247),
                                    ("hh:mmon <date>", -3.5393477201429726),
                                    ("absorption of , after named daySeptember",
                                     -4.127134385045092),
                                    ("on <date>September", -4.637960008811082),
                                    ("at <time-of-day>on <date>", -4.637960008811082),
                                    ("absorption of , after named dayFebruary", -4.127134385045092),
                                    ("July<integer> to|till|before <hour-of-day>",
                                     -5.043425116919247),
                                    ("tomorrowat <time-of-day>", -5.043425116919247),
                                    ("tomorrow<time-of-day> am|pm", -5.043425116919247),
                                    ("after <time-of-day><time-of-day> am|pm", -5.043425116919247),
                                    ("after <time-of-day>year", -5.043425116919247),
                                    ("yearminute", -5.043425116919247)],
                               n = 94}}),
       ...
       ("hh:mm",
        Classifier{okData =
                   ...
                   koData =
                     ClassData{prior = -2.468099531471619, unseen = -1.9459101490553135,
                               likelihoods = HashMap.fromList [("", 0.0)], n = 5}}),
       ("quarter of an hour",
        Classifier{okData =
                     ClassData{prior = 0.0, unseen = -1.791759469228055,
